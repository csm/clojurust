...
- [ ] `wasm-encoder` emitter (remaining `Inst`s): `LoadGlobal`/`LoadVar`/`DefVar` (reusing the rodata pool for name-as-data), unboxed `Long`/`Double` specialization aligned with `function_signature`
